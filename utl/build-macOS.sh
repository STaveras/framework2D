...
FRAMEWORK_FLAGS="-framework Metal -framework QuartzCore -framework Cocoa"
...
src/Timer.cpp src/Window.cpp src/Player.cpp src/IRenderer.cpp src/Renderer.cpp src/RendererVK.cpp src/RendererMTL.mm src/TextureVK.cpp src/TextureMTL.mm \
src/InputEvent.cpp src/IInput.cpp src/Trigger.cpp src/UpdateBackgroundOperator.cpp src/SDSParser.cpp src/PlatformInput.cpp src/PlatformKeyboard.cpp \
