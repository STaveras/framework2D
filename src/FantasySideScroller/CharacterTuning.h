...
inline constexpr float kRunMaxHorizontalSpeed = 150.0f;
inline constexpr float kAirMaxHorizontalSpeed = 125.0f;
...
inline constexpr float kRunAnimationSpeed = 1.5f;
